          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Observer(
                  builder: (_){
                    if(addProdutoController.tipoProdutoDto == null){
                      return Container(
                    ...
                    return CustomComboboxWidget(
                      itens: addProdutoController.tipoProdutoDto.categoriaProduto.map((data)=>Model(data.id,data.descricao)).toList(),
                      onChange: (item)=>addProdutoController.setSelectedCategoria(
                ...
                Observer(
                  builder: (_){
                    ...
                    return CustomComboboxWidget(
                      itens: addProdutoController.tipoProdutoDto.tipoProduto.map((data)=>Model(data.id,data.descricao)).toList(),
                      onChange: (item)=>addProdutoController.setSelectedTipo(
                          TipoCategoriaDto(id: item.id,descricao: item.descricao)
                      ),
                      itemSelecionado: null,
                    );
                ...
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: ()async {
                      bool result = await addProdutoController.salvar();
                      if(result){
